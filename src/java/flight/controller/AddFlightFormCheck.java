 ...
 * @author chatri.pi
 */
@WebServlet(name = "AddFlightFormCheck", urlPatterns = {"/addFlightFormCheck"})
public class AddFlightFormCheck extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (status)
        {
               ...
               arrivalAirport = (Airport) em.createNamedQuery("Airport.findByIcao").setParameter("icao", to).getSingleResult();            
                ...
                flight.setFlightNumber(Integer.parseInt(flight_number));
                flight.setFlightType(flightTypeEntity);
                flight.setDepartureAirport(departureAirport);
                flight.setArrivalAirport(arrivalAirport);
                flight.setDepartureTime(dhour+dminute);
                flight.setFlightDuration(hour+minute);
                flight.setFlightRoute(flight_route);
                flight.setRepeatRule(repeat_rule);
                ...
                {
                    errorMessage = "Problem encountered : please retry later AAAA";
                    status = false;
                }
        }
