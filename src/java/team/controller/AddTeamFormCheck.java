 ...
 * @author Loyd
 */
@WebServlet(name = "AddTeamFormCheck", urlPatterns = {"/addTeamFormCheck"})
public class AddTeamFormCheck extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (status) checkTeamName(teamName, em);
    ...
    private void checkTeamName(String teamName, EntityManager em)
    {
