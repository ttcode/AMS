 ...
 * @author Loyd
 */
@WebServlet(name = "AddTeamMember", urlPatterns = {"/addTeamMember"})
public class AddTeamMember extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        request.setAttribute("headtitle", "Add Team Member to Team \"" + team.getTeamName() + "\"");
        request.getRequestDispatcher("jsp/team/addTeamMember.jsp").forward(request, response);
    }
