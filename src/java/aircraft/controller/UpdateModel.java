...
public class UpdateModel extends HttpServlet 
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        if (request.getParameter("id") != null)
            ...
            return ;
        request.setAttribute("aircraftModel", (AircraftModel)query.getSingleResult());
        request.setAttribute("headtitle", "Update Aircraft Model");
        request.getRequestDispatcher("jsp/aircraft/UpdateModel.jsp").forward(request, response);
    }
