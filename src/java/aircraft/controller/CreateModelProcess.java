 ...
 */
@WebServlet(name = "CreateModelProcess", urlPatterns = {"/createModelProcess"})
public class CreateModelProcess extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            Query query = em.createNamedQuery("AircraftType.findById");
            ...
            /*List<AircraftModel> aircraftModelList = aircraftType.getAircraftModelList();
            aircraftModelList.add(aircraftModel);
            aircraftType.setAircraftModelList(aircraftModelList);*/
    ...
    private boolean formCheck(HttpServletRequest request, HttpServletResponse response) throws IOException
    {
        ...
        {
            EntityManager em = emf.createEntityManager();
            Query query = em.createNamedQuery("AircraftModel.findByAircraftModel");
        ...
        /*else
            response.sendRedirect("modelManagement");*/
        return (result);
    }
