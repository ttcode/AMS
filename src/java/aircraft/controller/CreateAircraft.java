...
@WebServlet(name = "CreateAircraft", urlPatterns = {"/CreateAircraft"})
public class CreateAircraft extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        if (!AppCore.initPage(request, response))
            return ;
        request.setAttribute("headtitle", "Add Aircraft");
        ...
        request.getRequestDispatcher("jsp/aircraft/CreateAircraft.jsp").forward(request, response);
