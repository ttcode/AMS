 ...
 * @author Loyd
 */
@WebServlet(name = "AddEmployeeFormCheck", urlPatterns = {"/addEmployeeFormCheck"})
public class AddEmployeeFormCheck extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (status)
        {
            ...
            // System account commit
            String salt = Encoder.encode("SHA-512", UUID.randomUUID().toString());
            SystemAccount account = new SystemAccount();
            account.setAccountType(accountTypeEntity);
            account.setRole(roleEntity);
            account.setLogin(login);
            account.setSalt(salt);
            account.setPassword(Encoder.encode("SHA-512", login.toLowerCase() + salt + password));
            ...
            if (status != false)
            {
                ...
                else
                {
                    ...
                    employee.setSystemAccount(account);
    ...
    private void checkLogin(String login, EntityManager em)
    {
