 ...
 * @author Jean
 */
@WebServlet(urlPatterns = {"/editAirport"})
public class EditAirport extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        request.setAttribute("headtitle", "Airport Edit: " + request.getParameter("icao"));
        request.getRequestDispatcher("jsp/airport/editAirport.jsp").forward(request, response);
    }
