 ...
 * @author Jean
 */
@WebServlet(name = "Pirep", urlPatterns = {"/pirep"})
public class Pirep extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        if (!AppCore.initPage(request, response))
            return ;
        request.setAttribute("headtitle", "Pilot Report");
        ...
        request.getRequestDispatcher("jsp/pilot/pirep.jsp").forward(request, response);
    }
